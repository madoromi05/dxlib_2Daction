...
void Enemy::ChangeAnimation(AnimState newState) {
...
void Enemy::Move(Map* map, int key) {
...
void Enemy::JumpMove(Map* map, bool jumpBtnPress)
{
...
void Enemy::JumpCheck(bool jumpBtnPress) {
...
void Enemy::MoveProcess(Map* map, bool jumpBtnPress) {
...
void Enemy::Draw(float cameraX, float cameraY) const {
